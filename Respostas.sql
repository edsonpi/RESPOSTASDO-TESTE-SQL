...
select * from carros 
where preco between '30.000' and '50.000';

SELECT * FROM carros ORDER BY preco DESC LIMIT  5;

SELECT fabricante, preco FROM carros WHERE  fabricante = 'fiat' AND preco < 30.000;

SELECT ano FROM carros WHERE ano >= 2015;

SELECT preco,fabricante FROM carros WHERE preco > 30.000 and fabricante = 'chevrolet';

SELECT preco, ano, fabricante FROM carros WHERE FABRICANTE = 'RENAULT'    ORDER BY preco DESC LIMIT 3;


DELETE  FROM carros WHERE modelo='FLUENCE';